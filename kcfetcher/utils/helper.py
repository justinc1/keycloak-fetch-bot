...
def normalize(identifier=""):
    if identifier == "ADFS First Broker Login":
        # TODO temporal hack here
        # We have 2 auth flows with names like "ADFS First Broker Login" and "ADFS first broker login".
        identifier = "adfs_first_broker_login___the_second_one"
