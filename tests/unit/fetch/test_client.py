...
class TestClientFetch_vcr:
    def test_fetch(self):
        ...
        # TODO drop certificate/private key - they are autogenerated and unpredictable
        data["attributes"].pop("saml.signing.certificate")
        data["attributes"].pop("saml.signing.private.key")
        assert data == {
